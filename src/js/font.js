...
export const stickString = string => {
  ...
  string
    ...
    .forEach(character => {
      ...
      charSegments.forEach(segment => {
        ...
        nextX = max(
          nextX,
          characterX + segment[0] + 2 / 5,
          characterX + segment[2] + 2 / 5
        );
      });
  ...
  absoluteSegments.forEach((x, offset) => {
    appearanceOffsets.splice(
      ~~(random() * appearanceOffsets.length),
      0,
      offset
    );
  });
...
const characterSettings = {
  ...
  c: [leftSegment, topSegment, bottomSegment],
  d: [leftSegment, [0, 0, 1, 1 / 2], [1, 1 / 2, 0, 1]],
  e: [leftSegment, topSegment, [0, 1 / 2, (1 * 2) / 3, 1 / 2], bottomSegment],
  f: [leftSegment, topSegment, [0, 1 / 2, (1 * 2) / 3, 1 / 2]],
  g: [topSegment, leftSegment, bottomSegment, rightBottomSegment],
  h: [leftSegment, rightSegment, middleHorizontalSegment],
  i: [leftSegment],
  j: [rightSegment, bottomSegment, [0, 1 / 2, 0, 1]],
  k: [leftSegment, [1, 0, 0, 1 / 2], [1, 1, 0, 1 / 2]],
  l: [leftSegment, bottomSegment],
  m: [leftSegment, [0, 0, 1 / 2, 1 / 2], [1, 0, 1 / 2, 1 / 2], rightSegment],
  n: [leftSegment, [0, 0, 1, 1], rightSegment],
  o: [topSegment, bottomSegment, leftSegment, rightSegment],
  p: [leftSegment, topSegment, [1, 0, 1, 1 / 2], middleHorizontalSegment],
  q: [topSegment, bottomSegment, leftSegment, rightSegment, [1, 1, 1, 1.3]],
  r: [
    leftSegment,
    topSegment,
    [1, 0, 1, 1 / 2],
  ...
  t: [topSegment, [1 / 2, 0, 1 / 2, 1]],
  u: [leftSegment, bottomSegment, rightSegment],
  v: [[0, 0, 1 / 2, 1], [1, 0, 1 / 2, 1]],
  w: [
    [0, 0, 1 / 4, 1],
    [1 / 4, 1, 1 / 2, 1 / 2],
    [3 / 4, 1, 1 / 2, 1 / 2],
  ...
  x: [[0, 0, 1, 1], [1, 0, 0, 1]],
  y: [[0, 0, 1 / 2, 1 / 2], [1 / 2, 1 / 2, 1, 0], [1 / 2, 1 / 2, 1 / 2, 1]],
  z: [topSegment, bottomSegment, [1, 0, 0, 1]],
  "'": [[0, 1 / 4, 1 / 4, 0]],
  "-": [[0, 1 / 2, 1, 1 / 2]]
};
