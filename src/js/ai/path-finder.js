...
export class PathFinder {
  ...
  closestExpandable(expandableSet, target) {
    ...
    expandableSet.nodeList.forEach(pathElement => {
      const heuristic =
        this.heuristicFor(pathElement.node, target) + pathElement.distance;
  ...
  expand(pathElement, expandableSet, expandedSet) {
    ...
    neighbors.forEach(neighborNode => {
      ...
      const neighborDistance =
        pathElement.distance +
        this.distanceBetween(pathElement.node, neighborNode);
      ...
      expandableSet.addNode(
        neighborHash,
        new PathNode(neighborNode, pathElement, neighborDistance)
      );
    });
  }
}
